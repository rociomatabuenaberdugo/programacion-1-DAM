...
public class Fraccion {
  ...
  void invierte() {
    ...
    numerador = aux;
    System.out.println("Si invertimos la fracción queda: " + numerador
            + "/" + denominador);
    aux = denominador;
    denominador = numerador;
    numerador = aux;
  ...
  void simplifica() {
    if (copiaNumerador < copiaDenominador) {
      ...
      System.out.println("Si simplificamos entre el número " + divFinal + " queda como: "
              + copiaNumerador + "/" + copiaDenominador);
    }
    if (copiaDenominador < copiaNumerador) {
      ...
      System.out.println("Si simplificamos entre el número " + div + " queda como: "
              + copiaNumerador + "/" + copiaDenominador);
    }
    if (copiaDenominador == copiaNumerador) {
      div = copiaNumerador;
  ...
  void multiplica(int a) {
    copiaNumerador2 *= a;
    copiaDenominador2 *= a;
    System.out.println("Si multiplicamos la fracción por " + a + " es: " + copiaNumerador2
            + "/" + copiaDenominador2);
  }
  ...
  void divide(int div) {
    if ((numerador % div == 0) && (denominador % div == 0)) {
      ...
      System.out.println("Si dividimos la fracción entre " + div + " es: " + copiaNumerador3
              + "/" + copiaDenominador3);
    }
  }
