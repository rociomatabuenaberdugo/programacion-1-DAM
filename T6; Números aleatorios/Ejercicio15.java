/**
* Ejercicio 15, números aleatorio: Realiza un generador de melodía con
...
*     igual a 4, menor o igual a 28 y siempre múltiplo de 4 (4, 8, 12...)
*   c) Cada grupo de 4 notas será un compás y estará separado del
*     siguiente compás mediante la barra vertical "|". El final de la
...
public class Ejercicio15 {
  public static void main(String[] args) {
	  ...
	  for (int cuenta = 1; cuenta <= notas; cuenta++) {
