...
public class Matematicas {
  ...
  /**
   * Devuelve verdadero si el número que se pasa como parámetro es capicúa y falso en caso
   * contrario.
   *
   * @param n un número entero positivo de hasta cinco cifras.
   * @return <b>true</b> en caso de que el número sea capicuo o <b>false</b> si no lo es.
   */
   ...
   *
   * @param s un número entero positivo, primo, mayor al número que se introduce como parámetro.
  ...
  /**
   * Da la posición de la primera ocurrencia de un dígito dentro de un número entero. Si no se
   * encuentra, devuelve -1.
   *
   * @param ne número entero que se introduce.
   * @param di digito que se introduce.
   * @return un <b>int</b> que es la primera posición en la que se encuentra el dígito que se ha
   ...
   * @return un <b>int</b> que es el número resultado de quitarle el número de dígitos solicitados.
   */
  ...
  /**
   * Toma como parámetros las posiciones inicial y final dentro de un número y devuelve el trozo
   * correspondiente.
   *
   ...
   * @return un <b>int</b> que es el número comprendido entre las dos posiciones solicitadas.
   */
   ...
   * @return un <b>int</b> que es el número resultado de juntar los dos números introducidos por el
   * usuario.
   */
   ...
   * @return un <b>int</b> que es el número resultado de pasar el número binario a decimal.
   */
   ...
   * @return un <b>int</b> que es el número resultado de pasar el número decimal a binario.
   */
  public static String decimal2binario(long num) {
    ...
    binario = new StringBuilder(binario).reverse().toString(); //Da la vuelta al String "binario".
    return binario;
  }
   ...
   *
   * @param num número introducido por el usuario en decimal.
   * @return un <b>int</b> que es el número resultado de pasar el número decimal a hexadecimal.
   */
  public static String decimal2hexa(long num) {

    String copiaBin = decimal2binario(num);
    long copia = Long.parseLong(copiaBin);
    String hexa = "";
    int[] numSepa = new int[digitos(copia)];

    for (int i = 0; i < digitos(copia); i++) {
      numSepa[i] = (int) trozoDeNumero(copia, digitos(copia) - 4, digitos(copia));
      copia = quitaPorDetras((int) copia, 4);
      hexa = "a";
    }
    return hexa;
  }
  ...
  /**
   * Genera un array de tamaño n con números aleatorios cuyo intervalo (mínimo y máximo) se indica
   * como parámetro.
   *
   * @param num número de elementos que contendrá el array.
   * @param numa primer número introducido por el usuario.
   * @param numb segundo número introducido por el usuario.
   * @return un <b>array</b> que es el array de tamaño aleatorio con tamaños aleatorios comprendidos
   * entre los valores indicados por el usuario.
   */
  public static int[] generaArrayInt(int numa, int numb, int num) {

    int[] x = new int[num];

    for (int i = 0; i < num; i++) {
      x[i] = (int) (Math.random() * (numb - numa + 1) + numa);
    }
    return x;
  }
   ...
   *
   * @param d número de elementos del array.
   * @param x[] array que se pasa como parámetro.
   * @return un <b>int</b> que es el número mínimo del array.
   */
  public static int minimoArrayInt(int[] x, int d) {
   ...
   * @param d número de elementos del array.
   * @param x[] array que se pasa como parámetro.
   * @return un <b>int</b> que es el número máximo del array.
   */
  public static int maximoArrayInt(int[] x, int d) {
   ...
   * @param d número de elementos del array.
   * @param x[] array que se pasa como parámetro.
   * @return un <b>int</b> que es la media del array.
   */
  public static float mediaArrayInt(int[] x, int d) {
